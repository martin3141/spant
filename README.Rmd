...
## Installation
Download and install the latest version of R (https://cran.ma.imperial.ac.uk/), or with your package manager if using a recent Linux distribution, eg `sudo apt install r-base`.
