...
The [spant user manual](https://spantdoc.wilsonlab.co.uk/) is written for users with minimal experience in R or MRS processing and is the best place to start.
