...
print.mol_parameters <- function(x, ...) {
  ...
  for (n in 1:length(x$spin_groups)) {
    ...
    if (nrow(x$spin_groups[[n]]$j_coupling_mat) > 1) {
      ...
      print(x$spin_groups[[n]]$j_coupling_mat)
    }
  }
}

get_m_cr_ch2_paras <- function(lw = 2, lg = 0) {
  get_uncoupled_mol("-CrCH2", 3.913, "1H", -2, lw, lg)
}

get_ala_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 4)
  ...
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
                       ...
                       lw = lw, lg = lg)
  paras <- list(spin_groups = list(spin_group_a), name = "Ala")
  class(paras) <- "mol_parameters"
  paras
}

get_asp_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 3)
  ...
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
                       j_coupling_mat = j_coupling_mat, scale_factor = 1,
                       lw = lw, lg = lg)
  paras <- list(spin_groups = list(spin_group_a), name = "Asp")
  class(paras) <- "mol_parameters"
  paras
}

get_cr_paras <- function(lw = 2, lg = 0) {
...
get_gaba_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 6)
...
get_gln_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 5)
...
get_gsh_paras <- function(lw = 2, lg = 0) {
  nucleus <- c("1H")
  chem_shift <- c(3.769)
  j_coupling_mat <- matrix(0, 1, 1)
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
...
get_gly_paras <- function(lw=2, lg=0) {
  get_uncoupled_mol("Gly",3.548,"1H",2,lw,lg)
}

get_ins_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 6)
...
get_lip09_paras <- function(ft) {
  get_uncoupled_mol("Lip09", 0.89, "1H", 3, 0.14 * ft / 1e6, 1)
}

get_lip13a_paras <- function(ft) {
  get_uncoupled_mol("Lip13a", 1.28, "1H", 2, 0.15 * ft / 1e6, 1)
}

get_lip13b_paras <- function(ft) {
  get_uncoupled_mol("Lip13b", 1.28, "1H", 2, 0.089 * ft / 1e6, 1)
}
...
get_mm09_paras <- function(ft) {
  get_uncoupled_mol("MM09", 0.91, "1H", 3, 0.14 * ft / 1e6, 1)
}

get_mm12_paras <- function(ft) {
  get_uncoupled_mol("MM12", 1.21, "1H", 2, 0.15 * ft / 1e6, 1)
}

get_mm14_paras <- function(ft) {
  get_uncoupled_mol("MM14", 1.43, "1H", 2, 0.17 * ft / 1e6, 1)
}

get_mm17_paras <- function(ft) {
  get_uncoupled_mol("MM17", 1.67, "1H", 2, 0.15 * ft / 1e6, 1)
}
...
get_naa_paras <- function(lw = 2, lg = 0) {
  nucleus <- c("1H")
  chem_shift <- c(2.008)
  j_coupling_mat <- matrix(0, 1, 1)
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
...
get_naag_paras <- function(lw = 2, lg = 0) {
  get_uncoupled_mol("NAAG", 2.042, "1H", 3, lw, lg)
}

get_pch_paras <- function(lw = 2, lg = 0) {
  nucleus <- c("1H")
  chem_shift <- c(3.208)
  j_coupling_mat <- matrix(0, 1, 1)
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
...
get_pcr_paras <- function(lw = 2, lg = 0) {
...
get_sins_paras <- function(lw = 2, lg = 0) {
  get_uncoupled_mol("sIns", 3.34, "1H", 6, lw, lg)
}

get_tau_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 4)
  ...
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
                       j_coupling_mat = j_coupling_mat, scale_factor = 1,
                       lw = lw, lg = lg)
  paras <- list(spin_groups = list(spin_group_a), name = "Tau")
  class(paras) <- "mol_parameters"
  paras
}

get_lac_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 4)
  ...
  paras <- list(spin_groups = list(spin_group_a), name = "Lac")
  class(paras) <- "mol_parameters"
  paras
}

get_glu_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 5)
  ...
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
                       j_coupling_mat = j_coupling_mat, scale_factor = 1,
                       lw = lw, lg = lg)
  paras <- list(spin_groups = list(spin_group_a), name = "Glu")
  class(paras) <- "mol_parameters"
  paras
}

get_glc_paras <- function(lw = 2, lg = 0) {
  nucleus <- rep("1H", 7)
  ...
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
                       j_coupling_mat = j_coupling_mat, scale_factor = 1,
                       lw = lw, lg = lg)
  paras <- list(spin_groups = list(spin_group_a), name = "Glc")
  class(paras) <- "mol_parameters"
  paras
}

get_gpc_paras <- function(lw = 2, lg = 0) {
  nucleus <- c("1H")
  chem_shift <- c(3.212)
  j_coupling_mat <- matrix(0, 1, 1)
  spin_group_a <- list(nucleus = nucleus, chem_shift = chem_shift, 
