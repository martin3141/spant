...
* Fixed a broken shebang line in the command-line scripts generated by
  install_cli, which caused "No such file or directory" errors on Linux.
* Replaced the non-functional tcltk fit_svs_gui() prototype with a working
